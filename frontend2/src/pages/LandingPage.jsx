...
const HeroSection = ({ setPage }) => (
  <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto px-6 py-20 text-center relative z-10">
      ...
      <p className="text-lg md:text-xl text-slate-500 dark:text-slate-400 max-w-2xl mx-auto mb-8 animate-fade-in-up delay-200 leading-relaxed">
        SheetSearch AI converts natural language questions into deterministic spreadsheet queries
        and executes them directly on your data. No hallucinations — just precise, explainable results.
      </p>

      <div className="flex flex-col items-center gap-2 mb-10 animate-fade-in-up delay-250">
        {[
          { icon: MessageSquare, text: "Natural language spreadsheet queries" },
          { icon: Zap, text: "Deterministic execution engine" },
          { icon: Shield, text: "Transparent execution traces" },
...
const HowItWorks = () => {
  const steps = [
    { icon: FileSpreadsheet, title: "Connect Your Data", desc: "Upload a CSV or XLSX, or link your Google Sheets. The schema is inferred automatically.", num: "01" },
    { icon: MessageSquare, title: "Ask in Plain English", desc: "Type any question about your data. The AI converts it into a deterministic query plan.", num: "02" },
    { icon: Sparkles, title: "Get Verified Answers", desc: "Results are computed by a Python execution engine — not generated by the LLM. Every step is traceable.", num: "03" },
  ];
  return (
...
const FeaturesGrid = () => {
  const features = [
    { icon: Zap, title: "Deterministic Query Engine", desc: "Natural language is compiled into a step-by-step execution plan. Results are always reproducible." },
